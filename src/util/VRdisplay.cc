...
///////////////////////////////////////////////////////////////////////////////
int VRDisplay::draw(int argc, char **argv)
{
    // init global vars
    initSharedMem();
    ...
    // load BMP image
    texId = loadTexture("frame92.bmp", true);
...
///////////////////////////////////////////////////////////////////////////////
int VRDisplay::initGLUT(int argc, char **argv)
{
...
///////////////////////////////////////////////////////////////////////////////
GLuint VRDisplay::loadTexture(const char* fileName, bool wrap)
{
    Image::Bmp bmp;
...
void renderEye(bool left_eye, Matrix4 matrixModel, Matrix4 matrixModelCommon, Matrix4 matrixView) {
...
void displayCB()
{
    ...
    renderEye(true, matrixModelL, matrixModelCommon, matrixView);
    renderEye(false, matrixModelR, matrixModelCommon, matrixView);
